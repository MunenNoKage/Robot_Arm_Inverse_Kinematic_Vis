...
\midrule
1--2 & Implement FK, rotation matrices, homogeneous transforms & All \\
3 & Implement Jacobian computation and DLS-based IK solver & Roman, Nazar \\
4 & Implement 3D projection and camera controls & Mykola \\
5 & Integrate IK + rendering into interactive visualization & All \\
6 & Testing, singularity edge cases, performance tuning & All \\
7 & Final report writing and presentation preparation & All \\
\bottomrule
\end{tabular}
\end{table}
